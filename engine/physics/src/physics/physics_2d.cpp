            ...
            case dmPhysics::JOINT_TYPE_POINT:
                {
                    ...
                    jointDef.bodyA            = b2_obj_b;
                    jointDef.bodyB            = b2_obj_a;
                    jointDef.target           = b2Vec2(params.m_PointJointParams.m_Target[0] * scale, params.m_PointJointParams.m_Target[1] * scale);
